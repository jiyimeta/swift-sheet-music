...
import Testing
    ...
    /// and `CGPoint` (see `Sources/SheetMusicLayout/Fonts/CGTypes+Android.swift`), so anchor
...
struct ChordLineLayoutTests {
    ...
    fileprivate static func chordLines(
    ...
    fileprivate static func twoChordNoteXs(
        first: String,
        second: String,
