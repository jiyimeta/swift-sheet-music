...
import Testing
    ...
    /// On Android and WebAssembly, Foundation's CoreGraphics shims also export `CGRect`
    ...
    ///
    /// `private typealias` keeps this file-scoped — a module-scope `typealias CGRect` here
