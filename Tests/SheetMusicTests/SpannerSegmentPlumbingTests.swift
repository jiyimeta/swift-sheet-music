...
import Testing
    ...
    /// `CGPoint` (see `Sources/SheetMusicLayout/Fonts/CGTypes+Android.swift`), so anchor
    /// explicitly to SheetMusicLayout's own definitions instead of leaving it ambiguous.
    ///
