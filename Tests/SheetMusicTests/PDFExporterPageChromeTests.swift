...
@Suite @MainActor struct PDFExporterPageChromeTests {
    ...
    @Test func headerFooterDisabledViaStyle() async throws {
        guard #available(macOS 15.0, iOS 16.0, *) else { return }
    ...
    @Test func headerOnFirstPageWhenEnabled() async throws {
        guard #available(macOS 15.0, iOS 16.0, *) else { return }
        var score = Self.minimalScore()
