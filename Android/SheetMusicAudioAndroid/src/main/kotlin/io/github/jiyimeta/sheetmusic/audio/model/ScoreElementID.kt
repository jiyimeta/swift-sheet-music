...
sealed class ScoreElementID {
    ...
    data class KeySignature(val measureIndex: Int, val staff: StaffAddress) : ScoreElementID()
    data class TimeSignature(val measureIndex: Int, val staff: StaffAddress) : ScoreElementID()
