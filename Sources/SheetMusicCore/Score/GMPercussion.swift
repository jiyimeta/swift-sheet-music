...
/// General MIDI percussion conventions shared by everything that builds a drum staff — the MIDI importer, the
/// blank-score factory, and any command that adds a drum part to an existing score. One definition so an
