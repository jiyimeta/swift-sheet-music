...
/// string tunings, ambitus, figured bass, and symbol. A measure repeat, location shift, and preserved source node
/// carry none and are refused as `.wrongElementKind(expected: .engravable)`.
///
